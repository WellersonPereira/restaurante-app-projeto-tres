...
class QueryPratos extends StatefulWidget {
  String tipo;
  QueryPratos(this.tipo);

  @override
  _QueryPratosState createState() => _QueryPratosState();
}
class _QueryPratosState extends State<QueryPratos> with AutomaticKeepAliveClientMixin {
